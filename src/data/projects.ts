...
export const projects: Project[] = [
  ...
  },
  {
    ...
    slug: 'height-table',
    title: 'Height Table',
    description: 'A data collection tool for logging vehicle height measurements on Cottrell CX-09LS auto haulers, designed to build a dataset for training a load compliance model.',
