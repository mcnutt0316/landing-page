...
// Sample project data - will be moved to separate data file in Phase 2
const projects = [
  {
    id: 1,
  ...
  },
  {
    ...
    description: "An experimental application exploring AI integration for content creation workflows.",
